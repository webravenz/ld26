...
com.webravenz.ld26.game.Game.prototype = $extend(com.webravenz.ld26.display.ASprite.prototype,{
	...
	,_onAddedToStage: function() {
		...
		this._player = new com.webravenz.ld26.game.entities.Player();
		this._layer.addEntity(this._player);
		this._score = 0;
		var font = nme.installer.Assets.getFont("assets/Square.ttf");
...
com.webravenz.ld26.game.entities.Bonus.prototype = $extend(com.webravenz.ld26.display.Entity.prototype,{
	...
	,_draw: function() {
		this.get_graphics().beginFill(this._colorCode);
		this.get_graphics().drawRect(-this._SIZE / 2,-this._SIZE / 2,this._SIZE,this._SIZE);
...
com.webravenz.ld26.game.entities.Player = function() {
	this.lose = false;
	this._SIZE = 16;
...
com.webravenz.ld26.game.entities.Player.prototype = $extend(com.webravenz.ld26.display.Entity.prototype,{
	_checkCollisions: function() {
		...
		while(_g < _g1.length) {
			var entity = _g1[_g];
			++_g;
			if(js.Boot.__instanceof(entity,com.webravenz.ld26.game.entities.Bonus)) entity.hit(100); else if(js.Boot.__instanceof(entity,com.webravenz.ld26.game.entities.Rect)) this.lose = true;
		}
	}
	...
	,draw: function() {
		...
		this.get_graphics().beginFill(this._colorCode);
		this.get_graphics().drawCircle(0,0,this._SIZE);
		this.get_graphics().endFill();
	}
	,_update: function() {
...
com.webravenz.ld26.game.entities.Rect.prototype = $extend(com.webravenz.ld26.display.Entity.prototype,{
	...
	,init: function(color,posX,posY,width,height) {
		this.set_x(posX);
		this.set_y(posY);
		this._collideGroup = color;
		this.setHitArea(0,0,width,height);
		this.draw(color,width,height);
	}
...
com.webravenz.ld26.game.Game.COLOR1 = 16754688;
com.webravenz.ld26.game.Game.COLOR2 = 43263;
