...
ApplicationMain.preloader_onComplete = function(event) {
	...
	if(Reflect.field(com.webravenz.ld26.Main,"main") == null) {
		var mainDisplayObj = new com.webravenz.ld26.Main();
		if(js.Boot.__instanceof(mainDisplayObj,browser.display.DisplayObject)) nme.Lib.get_current().addChild(mainDisplayObj);
	} else Reflect.field(com.webravenz.ld26.Main,"main").apply(com.webravenz.ld26.Main,[]);
}
var browser = {}
browser.text = {}
...
var NME_assets_font_square_ttf = function() {
	browser.text.Font.call(this);
};
$hxClasses["NME_assets_font_square_ttf"] = NME_assets_font_square_ttf;
NME_assets_font_square_ttf.__name__ = ["NME_assets_font_square_ttf"];
NME_assets_font_square_ttf.__super__ = browser.text.Font;
NME_assets_font_square_ttf.prototype = $extend(browser.text.Font.prototype,{
	__class__: NME_assets_font_square_ttf
});
...
browser.media.Sound.prototype = $extend(browser.events.EventDispatcher.prototype,{
	...
	,nmeLoad: function(stream,context,mime) {
		...
		if(mime == null || !browser.media.Sound.nmeCanPlayMime(mime)) console.log("Warning: '" + stream.url + "' with type '" + mime + "' may not play on this browser.");
...
com.webravenz = {}
com.webravenz.ld26 = {}
com.webravenz.ld26.Main = function() {
	browser.display.Sprite.call(this);
	this.addEventListener(browser.events.Event.ADDED_TO_STAGE,$bind(this,this.init));
};
$hxClasses["com.webravenz.ld26.Main"] = com.webravenz.ld26.Main;
com.webravenz.ld26.Main.__name__ = ["com","webravenz","ld26","Main"];
com.webravenz.ld26.Main.__super__ = browser.display.Sprite;
com.webravenz.ld26.Main.prototype = $extend(browser.display.Sprite.prototype,{
	init: function(e) {
		var game = new com.webravenz.ld26.game.Game();
		this.addChild(game);
	}
	,__class__: com.webravenz.ld26.Main
});
com.webravenz.ld26.display = {}
com.webravenz.ld26.display.ASprite = function() {
	browser.display.Sprite.call(this);
	this.addEventListener(browser.events.Event.ADDED_TO_STAGE,$bind(this,this._addedToStage));
	this.addEventListener(browser.events.Event.REMOVED_FROM_STAGE,$bind(this,this._removedFromStage));
};
$hxClasses["com.webravenz.ld26.display.ASprite"] = com.webravenz.ld26.display.ASprite;
com.webravenz.ld26.display.ASprite.__name__ = ["com","webravenz","ld26","display","ASprite"];
com.webravenz.ld26.display.ASprite.__super__ = browser.display.Sprite;
com.webravenz.ld26.display.ASprite.prototype = $extend(browser.display.Sprite.prototype,{
	_onRemovedFromStage: function() {
	}
	,_onAddedToStage: function() {
	}
	,_removedFromStage: function(e) {
		this.removeEventListener(browser.events.Event.REMOVED_FROM_STAGE,$bind(this,this._removedFromStage));
		this._onRemovedFromStage();
	}
	,_addedToStage: function(e) {
		this.removeEventListener(browser.events.Event.ADDED_TO_STAGE,$bind(this,this._addedToStage));
		this._onAddedToStage();
	}
	,__class__: com.webravenz.ld26.display.ASprite
});
com.webravenz.ld26.display.EntitiesLayer = function() {
	com.webravenz.ld26.display.ASprite.call(this);
	this._entities = new Array();
	this._entitiesToDelete = new Array();
};
$hxClasses["com.webravenz.ld26.display.EntitiesLayer"] = com.webravenz.ld26.display.EntitiesLayer;
com.webravenz.ld26.display.EntitiesLayer.__name__ = ["com","webravenz","ld26","display","EntitiesLayer"];
com.webravenz.ld26.display.EntitiesLayer.__super__ = com.webravenz.ld26.display.ASprite;
com.webravenz.ld26.display.EntitiesLayer.prototype = $extend(com.webravenz.ld26.display.ASprite.prototype,{
	_checkCollisions: function(entity) {
		entity.collides = new Array();
		var _g = 0, _g1 = this._entities;
		while(_g < _g1.length) {
			var entityCheck = _g1[_g];
			++_g;
			if(entityCheck.getCollideGroup() != 0 && entity.getCollideGroup() != entityCheck.getCollideGroup()) {
				if(entity.getArea().intersects(entityCheck.getArea())) entity.collides.push(entityCheck);
			}
		}
	}
	,_entityDestroyed: function(e) {
		this._entitiesToDelete.push(e.currentTarget);
	}
	,addEntity: function(entity) {
		this.addChildAt(entity,0);
		entity.addEventListener(com.webravenz.ld26.events.EntityEvent.DESTROYED,$bind(this,this._entityDestroyed));
		this._entities.push(entity);
	}
	,update: function() {
		var _g = 0, _g1 = this._entitiesToDelete;
		while(_g < _g1.length) {
			var entityDel = _g1[_g];
			++_g;
			HxOverrides.remove(this._entities,entityDel);
			if(this.contains(entityDel)) this.removeChild(entityDel);
			entityDel = null;
		}
		this._entitiesToDelete = new Array();
		var _g = 0, _g1 = this._entities;
	...
	,__class__: com.webravenz.ld26.display.EntitiesLayer
});
com.webravenz.ld26.display.Entity = function() {
	this.collisionCheck = false;
	this.collides = null;
	this._collideGroup = 0;
	this._life = 100;
...
$hxClasses["com.webravenz.ld26.display.Entity"] = com.webravenz.ld26.display.Entity;
com.webravenz.ld26.display.Entity.__name__ = ["com","webravenz","ld26","display","Entity"];
com.webravenz.ld26.display.Entity.__super__ = com.webravenz.ld26.display.ASprite;
com.webravenz.ld26.display.Entity.prototype = $extend(com.webravenz.ld26.display.ASprite.prototype,{
	getArea: function() {
		return new browser.geom.Rectangle(this.get_x() + this._area.x,this.get_y() + this._area.y,this._area.width,this._area.height);
	}
	,getCollideGroup: function() {
		return this._collideGroup;
	}
	,setHitArea: function(ax,ay,aw,ah) {
		this._area = new browser.geom.Rectangle(ax,ay,aw,ah);
	}
	,hit: function(power) {
		this._life -= power;
		if(this._life <= 0) {
	...
	,_destroy: function() {
		this.dispatchEvent(new com.webravenz.ld26.events.EntityEvent(com.webravenz.ld26.events.EntityEvent.DESTROYED));
	}
	,_checkCollisions: function() {
	}
	,checkCollisions: function() {
		if(this.collides != null && this.collides.length > 0) this._checkCollisions();
	}
	,_update: function() {
		var _g = this;
		_g.set_x(_g.get_x() + this._speedX);
		var _g = this;
		_g.set_y(_g.get_y() + this._speedY);
	}
	,update: function() {
		if(this._displayed) this._update();
	}
	,_onRemovedFromStage: function() {
		this._displayed = false;
	}
	...
	,__class__: com.webravenz.ld26.display.Entity
});
com.webravenz.ld26.events = {}
com.webravenz.ld26.events.EntityEvent = function(inType,inBubbles,inCancelable) {
	browser.events.Event.call(this,inType,inBubbles,inCancelable);
};
$hxClasses["com.webravenz.ld26.events.EntityEvent"] = com.webravenz.ld26.events.EntityEvent;
com.webravenz.ld26.events.EntityEvent.__name__ = ["com","webravenz","ld26","events","EntityEvent"];
com.webravenz.ld26.events.EntityEvent.__super__ = browser.events.Event;
com.webravenz.ld26.events.EntityEvent.prototype = $extend(browser.events.Event.prototype,{
	__class__: com.webravenz.ld26.events.EntityEvent
});
com.webravenz.ld26.game = {}
com.webravenz.ld26.game.Controls = function(stage) {
	this._right = false;
	this._left = false;
	browser.events.EventDispatcher.call(this);
	this._stage = stage;
};
$hxClasses["com.webravenz.ld26.game.Controls"] = com.webravenz.ld26.game.Controls;
com.webravenz.ld26.game.Controls.__name__ = ["com","webravenz","ld26","game","Controls"];
com.webravenz.ld26.game.Controls.__super__ = browser.events.EventDispatcher;
com.webravenz.ld26.game.Controls.prototype = $extend(browser.events.EventDispatcher.prototype,{
	right: function() {
		return this._right;
	}
	,left: function() {
	...
	,_onKeyDown: function(e) {
		...
		case 39:
			...
			break;
		case 32:
			this.dispatchEvent(new browser.events.Event(com.webravenz.ld26.game.Controls.SPACE));
			break;
		}
	}
	,__class__: com.webravenz.ld26.game.Controls
});
com.webravenz.ld26.game.Game = function() {
	this._scoreTimer = 60;
	this._noBonusTimer = 0;
	this._barTimer = 50;
	com.webravenz.ld26.display.ASprite.call(this);
};
$hxClasses["com.webravenz.ld26.game.Game"] = com.webravenz.ld26.game.Game;
com.webravenz.ld26.game.Game.__name__ = ["com","webravenz","ld26","game","Game"];
com.webravenz.ld26.game.Game.__super__ = com.webravenz.ld26.display.ASprite;
com.webravenz.ld26.game.Game.prototype = $extend(com.webravenz.ld26.display.ASprite.prototype,{
	_createBonus: function() {
		if(Math.random() > 0.99 && this._noBonusTimer <= 0) {
			var bonus = new com.webravenz.ld26.game.entities.Bonus();
			bonus.init();
			this._layer.addEntity(bonus);
		}
	}
	,_createBar: function() {
		this._barTimer = 160;
		this._noBonusTimer = 25;
		var s = Math.round(com.webravenz.ld26.game.Game.WIDTH * Math.random());
		var color1 = Math.random() > 0.5?1:2;
		var color2 = color1 == 1?2:1;
		var rect1 = new com.webravenz.ld26.game.entities.Rect();
		rect1.init(color1,0,-35,s,8);
		this._layer.addEntity(rect1);
		var rect2 = new com.webravenz.ld26.game.entities.Rect();
		rect2.init(color2,s,-35,com.webravenz.ld26.game.Game.WIDTH - s,8);
		this._layer.addEntity(rect2);
	}
	,_over: function() {
		this.removeEventListener(browser.events.Event.ENTER_FRAME,$bind(this,this._update));
		com.webravenz.ld26.game.Game.controls.stop();
	}
	,_onRemovedFromStage: function() {
	}
	,addScore: function(add) {
		this._score += add;
		this._scoreTxt.set_text("" + this._score);
	}
	,_update: function(e) {
		this._layer.update();
		this._barTimer -= com.webravenz.ld26.game.Game.speed;
		if(this._barTimer < 0) this._createBar();
		this._noBonusTimer -= com.webravenz.ld26.game.Game.speed;
		this._createBonus();
		com.webravenz.ld26.game.Game.speed += 0.001;
		this._scoreTimer--;
		if(this._scoreTimer <= 0) {
			this._scoreTimer = 60;
			this.addScore(1);
		}
		if(this._player.lose) this._over();
	}
	,_onAddedToStage: function() {
		var soundManager = new com.webravenz.ld26.game.SoundManager();
		this._layer = new com.webravenz.ld26.display.EntitiesLayer();
		this.addChild(this._layer);
		com.webravenz.ld26.game.Game.controls = new com.webravenz.ld26.game.Controls(this.get_stage());
		com.webravenz.ld26.game.Game.controls.start();
		this._player = new com.webravenz.ld26.game.entities.Player(this);
		this._layer.addEntity(this._player);
		this._score = 0;
		var font = nme.installer.Assets.getFont("assets/font/Square.ttf");
		this._scoreFormat = new browser.text.TextFormat(font.fontName,24,16777215);
		this._scoreFormat.align = browser.text.TextFormatAlign.RIGHT;
		this._scoreTxt = new browser.text.TextField();
		this._scoreTxt.set_defaultTextFormat(this._scoreFormat);
		this._scoreTxt.selectable = false;
		this._scoreTxt.embedFonts = true;
		this._scoreTxt.set_width(340);
		this._scoreTxt.set_x(0);
		this._scoreTxt.set_y(10);
		this._scoreTxt.set_text("" + this._score);
		this.addChild(this._scoreTxt);
		var sound = new browser.media.Sound();
		this.addEventListener(browser.events.Event.ENTER_FRAME,$bind(this,this._update));
	}
	,__class__: com.webravenz.ld26.game.Game
});
com.webravenz.ld26.game.SoundManager = function() {
	com.webravenz.ld26.game.SoundManager.sKick = nme.installer.Assets.getSound("assets/sound/hard_kick.wav");
	com.webravenz.ld26.game.SoundManager.sKick2 = nme.installer.Assets.getSound("assets/sound/snare_stick.wav");
	com.webravenz.ld26.game.SoundManager.sBonus = nme.installer.Assets.getSound("assets/sound/hh_frappe1.wav");
	com.webravenz.ld26.game.SoundManager.sBonus2 = nme.installer.Assets.getSound("assets/sound/hh_frappe2.wav");
};
$hxClasses["com.webravenz.ld26.game.SoundManager"] = com.webravenz.ld26.game.SoundManager;
com.webravenz.ld26.game.SoundManager.__name__ = ["com","webravenz","ld26","game","SoundManager"];
com.webravenz.ld26.game.SoundManager.prototype = {
	__class__: com.webravenz.ld26.game.SoundManager
}
com.webravenz.ld26.game.entities = {}
com.webravenz.ld26.game.entities.Bonus = function() {
	this._SIZE = 12;
	com.webravenz.ld26.display.Entity.call(this);
};
$hxClasses["com.webravenz.ld26.game.entities.Bonus"] = com.webravenz.ld26.game.entities.Bonus;
com.webravenz.ld26.game.entities.Bonus.__name__ = ["com","webravenz","ld26","game","entities","Bonus"];
com.webravenz.ld26.game.entities.Bonus.__super__ = com.webravenz.ld26.display.Entity;
com.webravenz.ld26.game.entities.Bonus.prototype = $extend(com.webravenz.ld26.display.Entity.prototype,{
	hit: function(power) {
		if(this._color == 1) com.webravenz.ld26.game.SoundManager.sBonus.play(); else com.webravenz.ld26.game.SoundManager.sBonus2.play();
		com.webravenz.ld26.display.Entity.prototype.hit.call(this,power);
	}
	,_draw: function() {
		var alt = Math.sqrt(3) / 2 * this._SIZE;
		this.get_graphics().lineStyle(3,this._colorCode,1,false,browser.display.LineScaleMode.NONE,browser.display.CapsStyle.SQUARE,browser.display.JointStyle.MITER);
		this.get_graphics().moveTo(0,-alt / 2 - 1);
		this.get_graphics().lineTo(-this._SIZE / 2,alt / 2 - 1);
		this.get_graphics().lineTo(this._SIZE / 2,alt / 2 - 1);
		this.get_graphics().lineTo(0,-alt / 2 - 1);
	}
	,_update: function() {
		this._speedY = com.webravenz.ld26.game.Game.speed;
		var _g = this;
		_g.set_rotation(_g.get_rotation() + this._rotationSpeed);
		com.webravenz.ld26.display.Entity.prototype._update.call(this);
	}
	,init: function() {
		this._color = Math.random() < 0.5?1:2;
		this._colorCode = this._color == 1?com.webravenz.ld26.game.Game.COLOR1:com.webravenz.ld26.game.Game.COLOR2;
		this._collideGroup = this._color == 1?2:1;
		this.set_x(com.webravenz.ld26.utils.AMath.random(20,com.webravenz.ld26.game.Game.WIDTH - 20));
		this.set_y(-20);
		this.set_rotation(com.webravenz.ld26.utils.AMath.random(0,90));
		this._rotationSpeed = com.webravenz.ld26.utils.AMath.random(2,5);
		if(Math.random() > 0.5) this._rotationSpeed = -this._rotationSpeed;
		this.setHitArea(-this._SIZE,-this._SIZE,this._SIZE * 2,this._SIZE * 2);
		this._draw();
	}
	,__class__: com.webravenz.ld26.game.entities.Bonus
});
com.webravenz.ld26.game.entities.Player = function(game) {
	this.lose = false;
...
$hxClasses["com.webravenz.ld26.game.entities.Player"] = com.webravenz.ld26.game.entities.Player;
com.webravenz.ld26.game.entities.Player.__name__ = ["com","webravenz","ld26","game","entities","Player"];
com.webravenz.ld26.game.entities.Player.__super__ = com.webravenz.ld26.display.Entity;
com.webravenz.ld26.game.entities.Player.prototype = $extend(com.webravenz.ld26.display.Entity.prototype,{
	_checkCollisions: function() {
		var _g = 0, _g1 = this.collides;
		while(_g < _g1.length) {
			var entity = _g1[_g];
			++_g;
			if(js.Boot.__instanceof(entity,com.webravenz.ld26.game.entities.Bonus)) {
				this._game.addScore(2);
				entity.hit(100);
			} else if(js.Boot.__instanceof(entity,com.webravenz.ld26.game.entities.Rect)) {
				var rect = js.Boot.__cast(entity , com.webravenz.ld26.game.entities.Rect);
				if(rect.color != this._color) this.lose = true; else if(!this._soundPlayed) {
					this._soundPlayed = true;
					if(this._color == 1) com.webravenz.ld26.game.SoundManager.sKick.play(); else com.webravenz.ld26.game.SoundManager.sKick2.play();
				}
			}
		}
	}
	,_swapColor: function(e) {
		if(this._color == 1) {
			this._color = this._collideGroup = 2;
			this._colorCode = com.webravenz.ld26.game.Game.COLOR2;
		} else {
			this._color = this._collideGroup = 1;
			this._colorCode = com.webravenz.ld26.game.Game.COLOR1;
		}
		this.draw();
	}
	,draw: function() {
		this._collideGroup = this._color;
		this.get_graphics().clear();
		this.get_graphics().lineStyle(4,this._colorCode,1,false,browser.display.LineScaleMode.NORMAL,browser.display.CapsStyle.SQUARE,browser.display.JointStyle.MITER);
		if(this._color == 1) {
			this.get_graphics().moveTo(-this._SIZE,-this._SIZE);
			this.get_graphics().lineTo(-this._SIZE,this._SIZE);
			this.get_graphics().lineTo(this._SIZE,this._SIZE);
			this.get_graphics().lineTo(this._SIZE,-this._SIZE);
			this.get_graphics().lineTo(-this._SIZE,-this._SIZE);
		} else this.get_graphics().drawCircle(0,0,this._SIZE);
	}
	,_update: function() {
		if(com.webravenz.ld26.game.Game.controls.left()) this._speedX -= this._ACCELERATION; else if(com.webravenz.ld26.game.Game.controls.right()) this._speedX += this._ACCELERATION; else this._speedX /= 2;
		this._speedX = com.webravenz.ld26.utils.AMath.limite(this._speedX,-this._SPEEDMAX,this._SPEEDMAX);
		com.webravenz.ld26.display.Entity.prototype._update.call(this);
		this.set_x(com.webravenz.ld26.utils.AMath.limite(this.get_x(),this._SIZE,350 - this._SIZE));
		if(this._soundPlayed && this.collides.length == 0) this._soundPlayed = false;
	}
	,_onRemovedFromStage: function() {
		com.webravenz.ld26.display.Entity.prototype._onRemovedFromStage.call(this);
		com.webravenz.ld26.game.Game.controls.removeEventListener(com.webravenz.ld26.game.Controls.SPACE,$bind(this,this._swapColor));
	}
	,_onAddedToStage: function() {
		com.webravenz.ld26.display.Entity.prototype._onAddedToStage.call(this);
		this.set_x(175);
		this.set_y(450);
		this._speedY = 0;
		this._speedX = 0;
		this.collisionCheck = true;
		var hitSize = Math.round(this._SIZE * 0.8);
		this.setHitArea(-hitSize / 2,-hitSize / 2,hitSize,hitSize);
		this._color = this._collideGroup = 1;
		this._colorCode = com.webravenz.ld26.game.Game.COLOR1;
		this.draw();
		com.webravenz.ld26.game.Game.controls.addEventListener(com.webravenz.ld26.game.Controls.SPACE,$bind(this,this._swapColor));
	}
	,__class__: com.webravenz.ld26.game.entities.Player
});
com.webravenz.ld26.game.entities.Rect = function() {
	com.webravenz.ld26.display.Entity.call(this);
};
$hxClasses["com.webravenz.ld26.game.entities.Rect"] = com.webravenz.ld26.game.entities.Rect;
com.webravenz.ld26.game.entities.Rect.__name__ = ["com","webravenz","ld26","game","entities","Rect"];
com.webravenz.ld26.game.entities.Rect.__super__ = com.webravenz.ld26.display.Entity;
com.webravenz.ld26.game.entities.Rect.prototype = $extend(com.webravenz.ld26.display.Entity.prototype,{
	draw: function(color,width,height) {
		var colorCode = color == 1?com.webravenz.ld26.game.Game.COLOR1:com.webravenz.ld26.game.Game.COLOR2;
		this.get_graphics().beginFill(colorCode);
	...
	,_update: function() {
		this._speedY = com.webravenz.ld26.game.Game.speed;
		com.webravenz.ld26.display.Entity.prototype._update.call(this);
		if(this.get_y() > 500) this._destroy();
	}
	,init: function(pcolor,posX,posY,width,height) {
		this.set_x(posX);
		this.set_y(posY);
		this.color = pcolor;
		this._collideGroup = 3;
		this.setHitArea(0,0,width,height);
		this.draw(this.color,width,height);
	}
	,__class__: com.webravenz.ld26.game.entities.Rect
});
com.webravenz.ld26.utils = {}
com.webravenz.ld26.utils.AMath = function() { }
$hxClasses["com.webravenz.ld26.utils.AMath"] = com.webravenz.ld26.utils.AMath;
com.webravenz.ld26.utils.AMath.__name__ = ["com","webravenz","ld26","utils","AMath"];
com.webravenz.ld26.utils.AMath.limite = function(val,min,max) {
	return val < min?min:val > max?max:val;
}
com.webravenz.ld26.utils.AMath.random = function(min,max) {
...
nme.installer.Assets.initialize = function() {
	if(!nme.installer.Assets.initialized) {
		nme.installer.Assets.resourceClasses.set("assets/font/Square.ttf",NME_assets_font_square_ttf);
		nme.installer.Assets.resourceNames.set("assets/font/Square.ttf","assets/font/Square.ttf");
		nme.installer.Assets.resourceTypes.set("assets/font/Square.ttf","font");
		nme.installer.Assets.resourceNames.set("assets/sound/hard_kick.wav","assets/sound/hard_kick.wav");
		nme.installer.Assets.resourceTypes.set("assets/sound/hard_kick.wav","sound");
		nme.installer.Assets.resourceNames.set("assets/sound/hh_frappe1.wav","assets/sound/hh_frappe1.wav");
		nme.installer.Assets.resourceTypes.set("assets/sound/hh_frappe1.wav","sound");
		nme.installer.Assets.resourceNames.set("assets/sound/hh_frappe2.wav","assets/sound/hh_frappe2.wav");
		nme.installer.Assets.resourceTypes.set("assets/sound/hh_frappe2.wav","sound");
		nme.installer.Assets.resourceNames.set("assets/sound/snare_stick.wav","assets/sound/snare_stick.wav");
		nme.installer.Assets.resourceTypes.set("assets/sound/snare_stick.wav","sound");
...
nme.installer.Assets.getSound = function(id) {
	...
	console.log("[nme.Assets] There is no Sound asset with an ID of \"" + id + "\"");
	return null;
}
var $_;
...
haxe.Resource.content = [{ name : "NME_assets_font_square_ttf", data : "s88587:"}];
...
com.webravenz.ld26.events.EntityEvent.DESTROYED = "ENTITY_DESTROYED";
com.webravenz.ld26.game.Controls.SPACE = "CONTROL_SPACE";
com.webravenz.ld26.game.Game.COLOR1 = 15538788;
com.webravenz.ld26.game.Game.COLOR2 = 12441137;
com.webravenz.ld26.game.Game.WIDTH = 350;
com.webravenz.ld26.game.Game.speed = 1;
